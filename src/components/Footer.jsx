...
const Footer = () => {
  return (
    ...
    <div className='footer-brandname'>
     ...
     <p className="footer-para">Grasse, France</p>
    </div>
...
<div className='footer-second-section'>
   <div>
    <ul className='footer-list'>
       <li className='footer-links heading'>House</li>
      <li className='footer-links'>Our story</li>
      <li className='footer-links'>Atelier</li>
      <li className='footer-links'>Sustainaibility</li>
    </ul>
   </div>
   ...
   <div>
    <ul className='footer-list '>
      ...
      <li className='footer-links'>Returns</li>
    </ul>
   </div>
  </div>
